...
if __name__ == "__main__":
    ...
    for i in range(2000):
        ...
        change_series_and_compute_ofv(fitted_discharges, metric="nse")
...
# TODO maximalfehler 1mm = maximale absolute differenz , nicht mean
    ...
    output_ddho.to_csv(main_dir / 'task_5' / 'output_ddho.csv')

    output_change = pd.DataFrame(save_change_vector)
    output_change.columns = range(output_change.shape[1])
    output_change.to_csv(main_dir / 'task_5' / 'output_change_value_ddho.csv')
