...
with open(main_dir / 'task_1' / 'outputs_task1' / "output.csv", "w", encoding="utf-8", newline="") as csvfile:  # main_dir.read_text()
...
outputs = pd.read_csv(main_dir / 'task_1' / 'outputs_task1' / 'output.csv' , sep=';')
df_diss = pd.read_csv(main_dir / 'task_1' / 'outputs_task1' / 'simulated_discharge.csv', sep=';')
